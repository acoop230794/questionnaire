...
//                 <select name="trivia_category" onChange="setCategory">
//                     <option value="9" name="category">Genral Knowledge</option>
//                     <option value="21" name="category">Mythology</option>
//                     <option value="20" name="category">Sport</option>
//                 </select>
//                 <label htmlFor="trivia_difficulty"></label>
//                 <select name="trivia_difficulty" onChange="setDifficulty">
